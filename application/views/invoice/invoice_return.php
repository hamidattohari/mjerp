				...
				<div class="row">
					<div class="col-md-12">
						<div class="text-center">
							<h3>LAPORAN PENGEMBALIAN MATERIAL <b style="text-transform: uppercase;"><?= $material_return->usage_categories ?></b></h3>
							<h4>No:  <?= $material_return->code ?></h4>
						</div>
						<p class="pull-left">Tanggal: <?= $date ?></p>
