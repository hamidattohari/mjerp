...
$(document).ready(function() {
	...
	$("#jsGrid").jsGrid({ 
        ...
        controller: {
        	loadData: function(filter) {
        		return $.ajax({
        			type: "GET",
        			url: site_url+"pickup_nonmaterial/jsgrid_functions/"+$('[name="asd"]').val(),
        			data: filter,
        			dataType:"JSON"
        		});
        	},
        	deleteItem: function(item) {
        		return $.ajax({
        			type: "DELETE",
        			url: site_url+"pickup_nonmaterial/jsgrid_functions",
        			data: item
        		});
        	}
        },
	...
	function generateID(){
		$.ajax({
			url : site_url+"pickup_nonmaterial/generate_id",
			type: "GET",
			data: {},
			dataType: "JSON",
	...
	table = $('#datatable').DataTable({
        ...
        ajax: {
            url: site_url+'pickup_nonmaterial/view_data/'+$('[name="woid"]').val()+"/"+$('[name="pid"]').val(),
            type: "POST",
            dataSrc : 'data',
            data: function ( d ) {
...
function printEvidence(id){
	window.open(site_url+"invoice/print_pickupnm/"+id);
}
