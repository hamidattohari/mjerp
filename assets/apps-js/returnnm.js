	...
	$("#jsGrid").jsGrid({ 
        ...
        controller: {
        	loadData: function(filter) {
        		return $.ajax({
        			type: "GET",
        			url: site_url+"return_nonmaterial/jsgrid_functions/"+$('[name="asd"]').val(),
        			data: filter,
        			dataType:"JSON"
        		});
        	},
        	deleteItem: function(item) {
        		return $.ajax({
        			type: "DELETE",
        			url: site_url+"return_nonmaterial/jsgrid_functions",
        			data: item
        		});
        	}
        },
...
function edit(id){
	...
	$('[name="change_id"]').val(id);
	$.ajax({
			url : site_url+"pickup_nonmaterial/get_by_id/"+id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
...
function printEvidence(id){
	window.open(site_url+"invoice/print_returnnm/"+id);
}
